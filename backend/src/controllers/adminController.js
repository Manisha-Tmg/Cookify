...
export const createAdminController = expressAsyncHandler(
  async (req, res, next) => {
...
export const verifyAdminController = expressAsyncHandler(
  async (req, res, next) => {
    ...
    if (token) {
      ...
      res.status(200).json({
        sucess: true,
        message: "Admin verified sucessfully",
        result: result,
      });
    }
  },
...
export const loginAdminController = expressAsyncHandler(
  async (req, res, next) => {
...
export const profileAdminController = expressAsyncHandler(
  async (req, res, next) => {
    let id = req.id;
...
export const updateProfileAdminCOntroller = async (req, res, next) => {
  try {
    let id = req.id;
    let data = req.body;
    delete data.email;
